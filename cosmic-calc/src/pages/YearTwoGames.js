    ...
    return (
      <div className="gameDiv">
          ...
          <QuestionCard
            ...
            playWrong={playWrong}
            score={score}
            functionQuestion={yearTwoPlanetTwoQuestion}
            functionAnswer={yearTwoPlanetTwoAnswer}
            noOfQuestions={noOfQuestions}
    ...
    return (
      <div className="gameDiv">
        ...
        <QuestionCardCompare
          ...
          playWrong={playWrong}
          score={score}
          functionQuestion={yearTwoPlanetEightQuestion}
          functionAnswer={yearTwoPlanetEightAnswer}
          noOfQuestions={noOfQuestions}
          setNoOfQuestions={setNoOfQuestions}
        />
        <div className="pointsHelpDiv">
