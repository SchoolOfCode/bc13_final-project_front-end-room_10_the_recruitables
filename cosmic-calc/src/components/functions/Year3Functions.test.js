...
import { yearThreePlanetEightQuestion, yearThreePlanetFiveQuestion, yearThreePlanetFourQuestion, yearThreePlanetOneQuestion, yearThreePlanetThreeQuestion, yearThreePlanetTwoQuestion } from "./Year3Functions";
    ...
    for (let i = 0; i < totalTests; i++) {
        ...
        describe(`Test ${i + 1} of ${totalTests}.`, () => {
            test("Ensure given values are between 100 and 999.", async () => {
                expect(questionValues[0] && questionValues[1]).toBeGreaterThanOrEqual(100);
    ...
    for (let i = 0; i < totalTests; i++) {
        ...
        describe(`Test ${i + 1} of ${totalTests}.`, () => {
            ...
            test("Ensure at least one value is one of the required integers.", async () => {
                expect([2, 3, 4, 5, 8, 10].includes(questionValues[0]) || [2, 3, 4, 5, 8, 10].includes(questionValues[1])).toBeTruthy();
            });
        });
    }
});
