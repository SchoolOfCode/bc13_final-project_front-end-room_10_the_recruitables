...
export function giveRandomFraction() {
  let newFraction = fractions[Math.floor(Math.random() * fractions.length)];
  return newFraction;
}

export function checkFractionAnswer(playerInput, newFraction) {
  let correctAnswer = newFraction;
